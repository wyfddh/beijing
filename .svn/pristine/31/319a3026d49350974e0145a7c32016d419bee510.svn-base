        ...
        <article class="cl pd-20" style="padding-left: 3rem">
            ...
            <div style="padding-bottom: 1rem;">
                <div class="clearfloat">
                    ...
                    <div class="mt-10">为了保证显示效果，展览主图的尺寸比例为16:9，最小尺寸为297*167，图片大小不要超过1M。</div>
                    <div class="row cl pd-10">
	                    <img id="image_id" style="max-width:297px;max-height:167px;margin-left:30px;" src="">
