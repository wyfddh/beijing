...
<section style="width:1200px;margin:0 auto;background:#fff;min-height:100%;">
    <form class="form form-horizontal" action="<%=request.getContextPath()%>/otherSpreadtrum/addOrUpdate.do" method="post" >
        ...
        <article class="cl pd-20" style="padding-left: 3rem">
            <p id="issue">
                <span id="issueTime">发布人：<input style="outline: none;border: none;font-size:15px;" value="${nickName} "/></span>
            </p>
            <p><span class="c-red">*</span>标题：<input type="text" id="title" class="input-text" placeholder="考古文物展" style="width: 50%" name="headline"></p>
            <p>展馆名称：<input type="text" class="input-text" style="width: 50%" name="musExhibition"></p>
            <div style="padding-bottom: 1rem;">
                <div class="clearfloat">
                    <span style="float:left;"><span class="c-red">*</span>主图:</span><br>
                    <div class="mt-20">提示：为了保证显示效果，展览主图的尺寸比例为16:9，最小尺寸为297*167，图片大小不要超过1M。</div>
                    <!-- <div class="main_img" style="padding-left: 2rem;padding-top: 0.3rem"><img src="images/news.png" alt="图片加载失败"></div> -->
                	 <div class="row cl pd-10">
		            <img id="image_id" src="" style="max-width:297px;max-height:167px;margin-left:30px">
