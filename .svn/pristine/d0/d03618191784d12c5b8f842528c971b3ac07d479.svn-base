...
<section class="Hui-article-box section_box">
    <div id="content_warp">
    	<div style="margin-bottom: 36px !important;">
			<span class="zj_edit_title">新增化石</span>
                ...
                <div class="tabCon">
                    ...
                    <div class="zj_edit_content">
                    	...
                    	<div class="col-xs-12" style="padding: 0;margin-bottom: 25px;">
	                        ...
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;margin-bottom: 9px;">
	                            ...
	                            <div class="formControls_spe">
	                                <input type="text" name="name" class="input-text mingcheng" value="${collection.name }">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>	
	                        ...
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;margin-bottom: 9px;">
	                            ...
	                            <div class="formControls_spe ">
	                                <input type="text" name="gsNo" class="input-text" value="${collection.gsNo }">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>                  		
	                        <div class="col-md-5 col-xs-12 col-sm-6" style="float: right;padding:0 0 0 24px;margin-bottom: 9px;">
	                            ...
	                            <div class="formControls_spe ">
		                            <span class="select-box">
								        <select class="select" id="" name="collectionsCategory">
	                        ...
	                        <div class="col-md-5 col-xs-12 col-sm-6" style="float: right;padding:0 0 0 24px;">
	                            ...
	                            <div class="formControls_spe">
		                            <span class="select-box" style="width: 58px;">
		                            	<select name="yearTypeEon" class="select yearType" style="width: 58px;">
									...
									<span class="select-box" style="width: 57px;">
										<select name="yearTypeEra" class="select yearType">
									...
									<span class="select-box" style="width: 57px;">
										<select name="yearTypeEpoch" class="select yearTypeEpoch">
	                    ...
	                    <div class="col-xs-12" style="margin-bottom: 20px;">
 						...
 						<div class="col-xs-12" style="margin-bottom: 20px;">
	                        <div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class="formControls">
	                                <input type="text" name="dwid" class="input-text" value="${collection.dwid }">
	                            </div>
	                            <div class=" col-xs-2"></div>
	                        </div>
	                        <div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class="formControls">
	                            	<span class="select-box">
								        <select class="select" id="" name="gsCollectionsNoType">
	                        ...
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;">
	                            ...
	                            <div class="formControls" style="width: 189px;">
	                                <input type="text" name="gsCollectionsNo" class="input-text" value="${collection.gsCollectionsNo }">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>	                    	
	                    </div>                   	
						...
						<div class="col-xs-12" style="margin-bottom: 20px;">
	                        <div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class="formControls">
	                                <input type="text" name="formerly" class="input-text" value="${collection.formerly }">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>	                    
	                    	...
	                    	<div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class="formControls ">
	                                <input type="text" name="gsSpecificYear" class="input-text" value="${collection.gsSpecificYear }">
	                            </div>
	                        </div>
	                        ...
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;">
	                            ...
	                            <div class="formControls "  style="width: 189px;">
	                            	<span class="select-box">
		                            	<select class="select" id="" name="gsSource">
                    	...
                    	<div class="col-xs-12" style="margin-bottom: 20px;">
	                    	<div class="col-md-4 col-xs-12 col-sm-6">
						        ...
						        <div class="formControls">
						            <input type="text" name="gsLength" class="input-text" value="${collection.gsLength }">
						        </div>
							</div>
							<div class="col-md-4 col-xs-12 col-sm-6">
						        <label class="form-label label_2">通宽:</label>
						        <div class="formControls">
						            <input type="text" name="gsWidth" class="input-text" value="${collection.gsWidth }">
						        </div>
							</div>
							<div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;">
						        <label class="form-label label_3">通高:</label>
						        <div class="formControls" style="width: 189px;">
						            <input type="text" name="gsHeight" class="input-text" value="${collection.gsHeight }">
						        </div>
							</div>							
						</div>
                    	...
                    	<div class="col-xs-12" style="margin-bottom: 20px;">
	                    	<div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class="formControls ">
	                                <input type="text" name="size" class="input-text" value="${collection.size }">
	                            </div>
	                        </div>						
	                        <div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class=" formControls">
	                            	<span class="select-box">
		                            	<select class="select" id="" name="actualQuantityUnit">
	                        ...
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;">
	                            ...
	                            <div class="formControls " style="width: 189px;">
	                                <input type="text" name="actualQuantity" class="input-text" value="${collection.actualQuantity }">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>	                        
						</div>
                    	...
                    	<div class="col-xs-12" style="margin-bottom: 20px;">
	                        ...
	                        <div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class="formControls ">
	                                <input type="text" name="gsEntryWarehouseTimeFrame" class="input-text" value="${collection.gsEntryWarehouseTimeFrame }">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;">
	                            ...
	                            <div class="formControls " style="width: 189px;">
	                                <input type="text" name="gsEntryWarehouseYear" class="input-text" value="${collection.gsEntryWarehouseYear }">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>
						</div>
                    	...
                    	<div class="col-xs-12" style="margin-bottom: 20px;">
	                       	<div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class="formControls ">
	                                <input type="text" name="collectionPlace" class="input-text" value="${collection.collectionPlace }">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>						
	                    	 <div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class="formControls ">
	                                <input type="text" name="creator" class="input-text" value="${collection.creator }">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>		
	                        <div class="col-md-4 col-xs-12 col-sm-6"  style="padding: 0;">
                    	...
                    	<div class="col-xs-12" style="padding-bottom: 20px;border-bottom: 6px solid #f1f2f7;">
                            ...
                            <div class="form-label formControls">
                                <div class="signl_check" style="width: 150px;">
                                    <div class="radio-box">
                                        <input type="radio" id="radio-1" name="isHighQuality" value="2" <c:if test="${'2' eq collection.isHighQuality}">checked</c:if> />
                                        <label for="radio-1">是</label>
                                    </div>
                                    <div class="radio-box">
                                        <input type="radio" id="radio-2" value="1" name="isHighQuality" <c:if test="${'1' eq collection.isHighQuality}">checked</c:if>>
                    ...
                    <div>
                        ...
                        <div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="form-label col-xs-6">
	                            <select name="yearTypeEon" class="select yearType">
								    <option value="">请选择宙</option>
								   <c:forEach items="${ytEonList}" var="eon" varStatus="row">
										<option value="${eon.id}" <c:if test="${eon.id eq collection.yearTypeEon}">selected</c:if> >${eon.name}</option>
									</c:forEach>
								</select>
								<select name="yearTypeEra" class="select yearType">
								    <option value="">请选择代</option>
								   <c:forEach items="${ytEraList}" var="era" varStatus="row">
										<option value="${era.id}" <c:if test="${era.id eq collection.yearTypeEra}">selected</c:if> >${era.name}</option>
									</c:forEach>
								</select>
								<select name="yearTypeEpoch" class="select yearTypeEpoch">
								    <option value="">请选择纪</option>
								   <c:forEach items="${ytEpochList}" var="epoch" varStatus="row">
										<option value="${epoch.id}" <c:if test="${epoch.id eq collection.yearTypeEpoch}">selected</c:if> >${epoch.name}</option>
									</c:forEach>
								</select>	
                    ...
                    <div>
                        ...
                        <div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="form-label col-xs-6">
	                            <span class="select-box">
	                            	<select class="select" id="" name="gsTexture">
										<option value="单一质地" <c:if test="${'单一质地' eq collection.gsTexture}">selected</c:if> >单一质地</option>
										<option value="复合或组合质地" <c:if test="${'复合或组合质地' eq collection.gsTexture}">selected</c:if> >复合或组合质地</option>
									</select>
								</span>
                            </div>
                        </div>
                        <div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="form-label col-xs-6">
                            	<span class="select-box">
	                            	<select class="select" id="" name="gsTextureCategory">
										<option value="有机质" <c:if test="${'有机质' eq collection.gsTexture}">selected</c:if> >有机质</option>
										<option value="无机质" <c:if test="${'复合或组合质地' eq collection.gsTexture}">selected</c:if> >无机质</option>
										<option value="有机复合或组合" <c:if test="${'复合或组合质地' eq collection.gsTexture}">selected</c:if> >有机复合或组合</option>
										<option value="无机复合或组合" <c:if test="${'复合或组合质地' eq collection.gsTexture}">selected</c:if> >无机复合或组合</option>
										<option value="有机无机复合或组合" <c:if test="${'有机无机复合或组合' eq collection.gsTexture}">selected</c:if> >有机无机复合或组合</option>
									</select>
								</span>
                            </div>
                        </div>
                    ...
                    <div>
                    	 <div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="formControls col-xs-6">
                                <input type="text" name="gsTextureSubcategories" class="input-text" value="${collection.gsTextureSubcategories }">
                            </div>
                            <%-- <div class="form-label col-xs-6">
                            	<span class="">
                    ...
                    <div>
                    	<div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="formControls col-xs-6">
                                <input type="text" name="massRange" class="input-text" value="${collection.massRange }">
                            </div>
                            <div class="col-3"></div>
                        </div>
                        <div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="formControls col-xs-4">
                                <input type="text" name="mass" class="input-text" value="${collection.mass }">
                            </div>
                            <div class="formControls col-xs-2">
                            	<span class="select-box">
	                            	<select class="select" id="" name="massUnit">
                        ...
                        <div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="formControls col-xs-6">
                                <input type="text" name="endResidueLevel" class="input-text" value="${collection.endResidueLevel }">
                            </div>
                            <div class="col-3"></div>
                        </div>
                    </div>
                    <div>
                    	 <div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="formControls col-xs-6">
                                <input type="text" name="endResidualCondition" class="input-text" value="${collection.endResidualCondition }">
                            </div>
                            <div class="col-3"></div>
                        </div>
                        <div class="row col-md-4 col-xs-12 col-sm-6">
                    ...
                    <div>
                    	 <div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="formControls col-xs-6">
                                <input type="text" name="gsAuthor" class="input-text" value="${collection.gsAuthor }">
                            </div>
                            <div class="col-3"></div>
                        </div>
                        <div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="formControls col-xs-6">
                                <input type="text" name="gsVersion" class="input-text" value="${collection.gsVersion }">
                            </div>
                            <div class="col-3"></div>
                        </div>
                       <div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="formControls col-xs-6">
                                <input type="text" name="gsKeepOnFile" class="input-text" value="${collection.gsKeepOnFile }">
                            </div>
                            <div class="col-3"></div>
                        </div>
                         <div class="row col-md-4 col-xs-12 col-sm-6">
                    ...
                    <div>
                        ...
                        <div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="formControls col-xs-6">
                                <input type="text" name="createTime" class="input-text" value="${collection.createTime }">
                            </div>
                            <div class="col-3"></div>
                        </div>
                       <div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="formControls col-xs-6">
                                <input type="text" name="submitTime" class="input-text" value="${collection.submitTime }">
                            </div>
                            <div class="col-3"></div>
                        </div>
                    </div>
                   ...
                   <%--  <div>
                    ...
                    <div class="button_wrap" style="padding-left:115px;padding-top:30px;">
                         <span class="btn-upload c">
                             <a id="saveTabOne" class="btn btn-primary radius saveinfo" style="margin-right: 1.5rem;background: #369593;color:#ffffff">修改</a>
                         </span>
                        <span class="btn-upload c">
		                      ...
		                      <div class="portfolio-content">
		                        <ul class="cl portfolio-area">
		                            <li class="item box-size">
		                                <div class="portfoliobox box-size">
		                                    <div class="picbox box-size">
		                                        <a href="${pic.thumb1}" data-lightbox="gallery" data-title="藏品缩略图640x426"><img src="${pic.thumb1}" style="max-width: inherit;max-height: inherit;width:280px;height:190px;margin-top: -20px;"></a>
		                                    </div>
		                            ...
		                            <li class="item box-size-L">
		                                <div class="portfoliobox box-size-L">
		                                    <div class="picbox box-size-L">
		                                        <a href="${pic.thumb2}" data-lightbox="gallery" data-title="藏品缩略图278x${pic.thumb2Height }"><img src="${pic.thumb2}" style="max-width: inherit;max-height: inherit;width:246px;height:166px;margin-top: -20px;"></a>
		                                    </div>
		                            ...
		                            <li class="item box-size-M">
		                                <div class="portfoliobox box-size-M">
		                                    <div class="picbox box-size-M">
		                                        <a href="${pic.thumb3}" data-lightbox="gallery" data-title="藏品缩略图192x128"><img src="${pic.thumb3}" style="max-width: inherit;max-height: inherit;width:212px;height:142px;margin-top: -20px;"></a>
		                                    </div>
           ...
           $("#saveTabOne").click(function(){
                if($(".mingcheng").val() == ""){
                    ...
                    return false;
                     ...
                     $.ajax({
                         url : "<%=request.getContextPath() %>/back/oCFossil/addOrUpdate.do",
                         type : "post",
                         data :  data,
                         dataType : "json",
...
$(function(){
	...
	$("#uploadPic_button").click(function() {
		...
		$.ajax({
			url : "<%=request.getContextPath() %>/file/uploadPicture.do?typeId=4",
			type : "post",
			data :  formData,
			dataType:"json",
			async: false,  
...
$(function(){
	...
	$(".btnMain").click(function(){
		...
		$.ajax({
			url : "<%=request.getContextPath()%>/back/oCFossil/setMain.do",
			type : "post",
			data :  {picId : pic_id, collectionId : c_id,typeId : 4},
			dataType : "json",
			success : function(data){
				if(data){
