...
//              }
  ...
  public static String getIndexStyle(String easyui_theme) {
		HashMap<String, String> hmEasyUI = new HashMap<String, String>();
		hmEasyUI.put("black", "iblack");
		hmEasyUI.put("bootstrap", "iblue");
		hmEasyUI.put("default", "default");
		hmEasyUI.put("gray", "idialog");
		hmEasyUI.put("metro", "chrome");
		hmEasyUI.put("icons", "igreen");
		return hmEasyUI.get(easyui_theme);
	}
}
