...
<style>
	...
	.zj_menu_hearder{
		...
		margin-bottom: 6px;
		overflow: hidden;
		background:url(/admin/back/images/bg_main.png) ;
	}
	.thirdTitle img{
			...
			<dd style="display:block">
				<ul class="secondtitle">
					<li>
						...
						<ul class="thirdTitle">
							<li class="zj_public_cangpin">
								<a href="/admin/back/oCCollection/info.do" rel="/mip/back/oCCollection/info.do" title="藏品库">
									<%-- <img src="<%=request.getContextPath() %>/back/images/zj_wenwu.png"/> --%>
									藏品库
								</a>
							</li>
							<li class="zj_public_gkcangpin">
								<a href="/admin/collectionInfo/info.do?collectionType=0" rel="/collectionInfo/info.do?collectionType=0" title="公开藏品库">
									<%-- <img src="<%=request.getContextPath() %>/back/images/zj_huashi.png"/> --%>
									公开藏品库
								</a>
							</li>
							<li class="zj_public_gjjlcangpin">
								<a href="/admin/dcBorrow/info.do?collectionType=1" rel="/mip/dcBorrow/info.do?collectionType=1" title="馆际交流藏品库">
									<%-- <img src="<%=request.getContextPath() %>/back/images/zj_huashi.png"/> --%>
									馆际交流藏品库
								</a>
							</li>
...
<!--/_menu 作为公共模版分离出去-->
    ...
    <script type="text/javascript">
        ...
        $(function(){
				...
				if('597cf7b6d64e401fa15e13d850231a87' == userId){
					$('.zj_public_yipuWenwu').hide();
					$('.zj_public_yipuhuashi').hide();
				}
			})
    </script>
<!--/请在上方写此页面业务相关的脚本-->
