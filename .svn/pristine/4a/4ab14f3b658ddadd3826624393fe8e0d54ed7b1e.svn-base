...
<form class="layui-form" id="newForm">
	...
	<div class="layui-col-xs4" style="padding-left: 20px;">
		...
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<textarea type="text" class="layui-textarea textarea" lay-verify="required" placeholder="" value="${article.description }" name="description" id="description" row="3" style="width:95%;resize:none;" readonly="readonly">${article.description }</textarea>
		</div>
