...
<head>
    ...
    <meta name="description" content="">
     ...
     <style>
        ...
        .zj_edit_audio>span:nth-child(2){
        	display: inline;
        	color: white;
        	background-color: #2a9bcf;
        	width: 82px;
...
<section class="Hui-article-box section_box">
    <div id="content_warp">
    	<div style="margin-bottom: 36px !important;">
    		<span class="zj_edit_title">编辑藏品</span>
                    ...
                    <div class="zj_edit_content" style="">
                    	<div class="col-xs-12" style="padding: 0;margin-bottom: 25px;">
	                        ...
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;margin-bottom: 9px;">
	                            ...
	                            <div class="formControls_spe ">
	                                <input type="text" name="gsNo" class="input-text puchaNum" value="${collection.gsNo }" >
	                            </div>
	                            <div class="col-3"></div>
	                        </div>                  		
	                        <div class="col-md-5 col-xs-12 col-sm-6" style="float: right;padding:0 0 0 24px;margin-bottom: 9px;">
	                            ...
	                            <div class="formControls_spe ">
		                            <span class="select-box">
								        <select class="select" name="collectionsCategory">
								        	<option value="">请选择</option>
						...
						<div class="col-xs-12" style="margin-bottom: 50px;">
	                        ...
	                        <textarea name="description" class="textarea cangpinjianjie" onkeyup="checkLength(this);">${collection.description }</textarea>
	                    ...
	                    <div class="col-xs-12" style="margin-bottom: 20px;">
	                        ...
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;">
	                            ...
	                            <div class="formControls" style="width: 189px;">
	                                <input type="text" name="gsCollectionsNo" class="input-text cangpinNum" value="${collection.gsCollectionsNo }">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>	                    	
	                    </div>
						...
						<div class="col-xs-12" style="margin-bottom: 20px;">
	                        <div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class="formControls">
	                                <input type="text" name="formerly" class="input-text yuanming" value="${collection.formerly }">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>							
	                    	<div class="col-md-4 col-xs-12 col-sm-6">
						...
						<div class="col-xs-12" style="margin-bottom: 20px;">
	                        ...
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;">
	                            ...
	                            <div class="form-label formControls"  style="width: 189px;">
	                            	<span class="select-box">
		                            	<select class="select zhidiziType" id="" name="gsTextureSubcategories">
		                            		<option value="">请选择</option>
						...
						<div class="col-xs-12" style="margin-bottom: 20px;">
	                    	<div class="col-md-4 col-xs-12 col-sm-6">
						        ...
						        <div class="formControls">
						            <input type="text" name="gsLength" class="input-text ckg tongchang" value="${collection.gsLength }">
							...
							<div class="col-md-4 col-xs-12 col-sm-6">
						        ...
						        <div class="formControls">
						            <input type="text" name="gsWidth" class="input-text ckg tongkuan" value="${collection.gsWidth }">
							...
							<div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;">
						        ...
						        <div class="formControls" style="width: 189px;">
						            <input type="text" name="gsHeight" class="input-text ckg tonggao" value="${collection.gsHeight }">
						...
						<div class="col-xs-12" style="margin-bottom: 20px;">
	                        ...
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;">
	                            ...
	                            <div class="formControls " style="width: 189px;">
	                                ...
	                                <input type="text" name="actualQuantity" class="input-text" hidden value="${collection.actualQuantity }">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>	                        
						</div>
                			...
                			<li class="item box-size zj_edit_imgLi">
                                ...
                                <div class="portfoliobox box-size">
                                    <div class="picbox box-size">
                                    	...
                                    	<input type="hidden" name="pictureIds" value="${pic.id }">
                                    	<input type="hidden" name="picUrl" value="${pic.url }">
                                    	<input type="hidden" name="fileName" value="${pic.name }">
                                    	<input type="hidden" name="width" value="${pic.picWidth }">
                                    	<input type="hidden" name="height" value="${pic.picHeight }">
                                    </div>
        ...
        <form id="uploadFormVideo" enctype="multipart/form-data" method="post" >
	         <div id="coverVideo">
	             ...
	             <div class="cl pt-20 pl-30 col-offset-1" style="padding-top: 120px;">
	                 <label class="col-xs-4 col-sm-3 text-r col-md-2 c-white lig" id="videoTitle">请选择视频：</label>
        ...
        <form id="uploadFormAudio" enctype="multipart/form-data" method="post" >
	         <div id="coverAudio">
	             <a href="javascript:;" class="Hui-iconfont c-white btn btn-danger close">&#xe6a6;</a>
	             <div class="cl pt-20 pl-30 col-offset-1" style="padding-top: 120px;">
	                 <label class="col-xs-4 col-sm-3 text-r col-md-2 c-white lig" id="audioTitle">请选择音频：</label>
	                 <div class="formControls col-xs-8 col-sm-9 col-md-8">
		                 <span class="btn-upload form-group">
...
indexOpen = parent.layer.getFrameIndex(window.name); //获取窗口索引
    $(function () {
...
<script>
         $(function(){
              $("#saveTabOne").click(function(){
            	 // var dataObj=eval("("+${collection}+")");
            	 // alert($('#form-collection-add').form('isChange',dataObj));
                   if($(".mingcheng").val() == ""){
                       layer.open({
                       title: '提示',
                       content: '名称不能为空'
                   ...
                   return false;
                       ...
                       $.ajax({
                           url : "<%=request.getContextPath() %>/collections/addOrUpdate.do",
                           type : "post",
                           data :  data,
                           dataType : "json",
...
<%-- $(function(){
	...
	$("#uploadPic_button").click(function() {
		...
		$.ajax({
			url : "<%=request.getContextPath() %>/file/uploadPicture.do?typeId=3",
			type : "post",
			data :  formData,
			dataType:"json",
			async: false,  
...
$(function(){
	...
	$(".btnMain").click(function(){
		...
		$.ajax({
			url : "<%=request.getContextPath()%>/collections/setMain.do",
			type : "post",
			data :  {picId : pic_id, collectionId : c_id, typeId : 3},
			dataType : "json",
			success : function(data){
				if(data){
...
<script type="text/javascript">
	...
	layui.use(['form','layer','upload'],function(){
		...
		$("#mypicture").click(function(){
		    ...
		    var index = layui.layer.open({
			      title : "裁剪图片",
			      type : 2,
			      content : "<%=request.getContextPath() %>/cropper/collect_crop.jsp?type=4",
				  area: ['80%', '600px'],
				  success : function(layero,index,data1){
				  		var body = layui.layer.getChildFrame('body', index);
			            setTimeout(function(){
			                layui.layer.tips('点击此处返回藏品详情', '.layui-layer-setwin .layui-layer-close', {
			                    tips: 3
			                });
			            },500)
					},
	...
	function setTitleImg(absolurl, relativeurl,fileName,width,height){
		$.cookie('word_msg', '1'); 
		$("#pictureUL").append(
    			'<li class="item box-size zj_edit_imgLi">'
                +'<div class="clo">x</div>'
                +'<div class="portfoliobox box-size">'
                +'<div class="picbox box-size">'
                +'<a href="'+absolurl+'" data-lightbox="gallery" data-title="'+fileName+'" ><img src="'+absolurl+'" class="size-XXL"></a>'
                +'</div>'
                +'<div style="margin-top: -20px;"><span style="padding-left: 10px;">'+fileName+'</span>'
                +'</div>'
                +'<div style="position: absolute;bottom: 3px;right: 3px;">'
                +'</div>'
                +'<input type="text" class="input-text hidden" name="picUrl" value="'+relativeurl+'">'
                +'<input type="text" class="input-text hidden" name="fileName" value="'+fileName+'">'
                +'<input type="text" class="input-text hidden" name="width" value="'+width+'">'
                +'<input type="text" class="input-text hidden" name="height" value="'+height+'">'
                +'</div>'
                +'</li>');
    ...
    <script>
        ...
        $(".portfolio-area").delegate("li .clo","click",function(){
            ...
            <%--alert(thisId);--%>
            $.ajax({
                url:"<%=request.getContextPath() %>/collections/deletePic.do",
                type:"post",
                data:{
                    picId:thisId
                },
