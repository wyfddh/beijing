...
<!-- 			<button type="button" lay-submit class="layui-btn layui-btn-danger" lay-filter="publish" id="publish">发布</button> -->
		...
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<textarea type="text" class="layui-textarea textarea" onkeyup="checkLength(this);" placeholder="这里输入描述" value="" name="description" id="description" row="3" style="width:95%;resize:none;"></textarea>
...
layui.use(['form','layer','laydate','upload'],function(){
    ...
    $("#uploadImg").click(function(){
    	var index = layui.layer.open({
		      title : "裁剪图片",
		      type : 2,
		      content : "<%=request.getContextPath() %>/cropper/Article_crop.jsp?type=1",
			  area: ['90%', '600px'],
