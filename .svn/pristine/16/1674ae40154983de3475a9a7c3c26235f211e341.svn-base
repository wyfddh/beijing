package com.design.core.common.hibernate.qbc;
...
import com.design.core.common.model.json.DataGrid;
import com.design.core.common.model.json.DataTables;
import com.design.core.common.model.json.SortDirection;
import com.design.core.common.model.json.SortInfo;
...
public class CriteriaQuery implements Serializable {
	...
	public CriteriaQuery(Class c,String qName) {
		this.detachedCriteria = DetachedCriteria.forClass(c,qName);
	...
	public CriteriaQuery(Class entityClass,DataGrid dg,String qName) {
		...
		this.detachedCriteria = DetachedCriteria.forClass(entityClass,qName);
	...
	public void eq(String keyname, Object keyvalue) {
		if (keyvalue != null && keyvalue != "") {
			...
			criterionList.add(Restrictions.or(Property.forName(keyname).isNull(),Restrictions.eq(keyname,"")));
		}
	}
...
//		criterionList.add(Restrictions.or(Property.forName(keyname).isNotNull(),Restrictions.ne(keyname,"")));
//		criterionList.addPara(Restrictions.isNotNull(keyname));
		criterionList.add(Restrictions.isNotNull(keyname));
		criterionList.add(Restrictions.ne(keyname,""));
	}
