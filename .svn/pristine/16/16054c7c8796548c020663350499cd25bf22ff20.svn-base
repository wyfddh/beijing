	            ...
	            <div class="a5">
	                ...
	                <span class="a8">
	                	<c:if test="${num.index == 0 and !num.last}">
		                	...
		                	<a class="down1 down" title="下移" onclick="editSort('down', '${list.topicCollectionId}');"><span></span></a>
	                	</c:if>
	                	<c:if test="${num.index == 0 and num.last}">
		                	<a class="up1" title="上移"><span></span></a>
	                	...
	                	<c:if test="${num.index != 0 and !num.last }">
		                	<a class="up2 up" title="上移" onclick="editSort('up', '${list.topicCollectionId}');"><span></span></a>
		                	<a class="down2 down" title="下移" onclick="editSort('down', '${list.topicCollectionId}');"><span></span></a>
	                	</c:if>
	                	<c:if test="${num.index != 0 and num.last }">
		                	<a class="up3 up" title="上移" onclick="editSort('up', '${list.topicCollectionId}');"><span></span></a>
		                	<a class="down3" title="下移"><span></span></a>
	                	</c:if>
	                </span>
	            </div>
...
<script type="text/javascript">
	...
	function editSort(type, id){
		$.ajax({
            type: "POST",
            url: "<%=request.getContextPath() %>/topic/editSequence.do",
