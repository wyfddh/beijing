...
import com.tj720.mip.inter.dao.ApplicationDetailsDao;
...
public class ApplicationDetailsDaoImpl extends BaseDao<ApplicationDetails> implements ApplicationDetailsDao{
