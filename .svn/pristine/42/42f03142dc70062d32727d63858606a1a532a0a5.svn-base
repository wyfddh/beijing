...
eval("var oSelectListPJ = document.getElementById('selectListPJ');");

eval("var  oClearListPJ = $('#queryModel_PJ11_').find('#clearList_PJ11_');");



var oCustext1 = document.getElementById('custext1');
var oCustext2 = document.getElementById('custext2');
eval("var aItemTxt = oSelectListPJ.getElementsByTagName('a');");
var isCusPrice = false;//是否自定义价格
var radioVal = '';

eval("oSelectListPJ").onclick = function(e, a) {
            ...
            if (oPrevInput && oPrevInput.getAttribute('type').toUpperCase() == 'RADIO') { //radio
             ...
             var typegroupId=tag.getAttribute('typegroupId');
	   		 ...
	   		 if(value!=null&&value!=""){
	   			...
	   			eval("oClearListPJ").append(infor);
    }
		}
    }
...
$("#clearList_PJ11_").on("click", "em", function () {
...
$("#selectListPJ").on("blur", ".sl-inputtext-ss", function () {
...
//  $(oSelectList).find('input').attr('checked',false);
  ...
  isCusPrice = false;
  okSelect.length = 0;
  $(eval("oSelectListPJ")).trigger('click', 1);
