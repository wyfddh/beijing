...
<section class="Hui-article-box section_box">
    <div id="content_warp">
    	<div style="margin-bottom: 36px !important;">
			<span class="zj_add_title">新增化石</span>
                ...
                <div class="tabCon">
                	...
                	<div class="zj_add_content">
                    	<div class="col-xs-12" style="padding: 0;margin-bottom: 25px;">
	                        ...
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;margin-bottom: 9px;">
	                            ...
	                            <div class="formControls_spe ">
	                                <input type="text" name="gsNo" class="input-text" value="">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>                  		
	                        <div class="col-md-5 col-xs-12 col-sm-6" style="float: right;padding:0 0 0 24px;margin-bottom: 9px;">
	                        ...
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;">
	                            ...
	                            <div class="formControls_spe ">
	                                <input type="text" class="input-text" value="${org.name}" readonly="readonly" disabled="disabled">
                    	...
                    	<div class="col-xs-12" style="margin-bottom: 50px;">
 						...
 						<div class="col-xs-12" style="margin-bottom: 20px;">
	                        ...
	                        <div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class="formControls">
	                            	<span class="select-box">
								        <select class="select"  name="gsCollectionsNoType">
								        	<option value="">请选择</option>
	                        ...
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;">
	                            ...
	                            <div class="formControls" style="width: 189px;">
	                                <input type="text" name="gsCollectionsNo" class="input-text" value="">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>	                    	
	                    </div>
                    	...
                    	<div class="col-xs-12" style="margin-bottom: 20px;">
	                        <div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class="formControls">
	                                <input type="text" name="formerly" class="input-text" value="">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>	                    
                    ...
                    <div>
                    	 <div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="formControls col-xs-6">
                                <input type="text" name="gsTextureSubcategories" class="input-text" value="">
                            </div>
                   		 </div>
                        <div class="row col-md-4 col-xs-12 col-sm-6">
                            <label class="form-label col-xs-6">实际数量：</label>
                            <div class="formControls col-xs-6">
                                <input type="text" name="" class="input-text" value="" id = "trueNum">
                                <input type="text" name="actualQuantity" class="input-text" value="1" hidden>
                            </div>
                            <div class="col-3"></div>
                        </div>
                    ...
                    <div>
                    	...
                    	<div class="row cl col-md-4 col-xs-12 col-sm-6">
						    ...
						    <div class="col-lg-6  col-xs-6">
						        <label class="form-label col-xs-7">通长:</label>
						        <div class="formControls col-xs-5" style="padding:0;margin:0">
						            <input type="text" class="input-text ckg" value="">
						            <input type="text" name="gsLength" class="input-text" value="0" hidden>
						        </div>
						    </div>
						 </div>
						 <div class="row cl col-md-4 col-xs-12 col-sm-6">
						    <div class="col-lg-6 col-xs-6">
						        <label class="form-label col-xs-7">通宽:</label>
						        <div class="formControls col-xs-5" style="padding:0;margin:0">
						            <input type="text" class="input-text ckg" value="">
						            <input type="text" name="gsWidth" class="input-text" value="0" hidden>
						        </div>
						    ...
						    <div class="col-lg-6 col-xs-6">
						        <label class="form-label col-xs-7">通高:</label>
						        <div class="formControls col-xs-5" style="padding:0;margin:0">
						            <input type="text"  class="input-text ckg" value="">
						             <input type="text" name="gsHeight" class="input-text" value="0" hidden>
						        </div>
	                    			...
	                    			<li class="item box-size">
		                                <div class="portfoliobox box-size">
		                                    <div class="picbox box-size">
		                                        <a href="${pic.url }" data-lightbox="gallery" data-title="${pic.name }" ><img src="<%=request.getContextPath()%>/${pic.url }" class="size-XXL"></a>
		                                    </div>
                    ...
                    <div class="portfolio-content">
                        <ul class="cl portfolio-area">
                            <li class="item box-size">
                                <div class="portfoliobox box-size">
                                    <div class="picbox box-size">
                                        <a href="temp/big/keting.jpg" data-lightbox="gallery" data-title="客厅1"><img src="temp/Thumb/keting.jpg" style="max-width: inherit;max-height: inherit;width:280px;height:190px;margin-top: -20px;"></a>
                                    </div>
                                    <div style="margin-top: -20px;"><span style="padding-left: 10px;">客厅</span></div>
                                </div>
                            </li>
                            <li class="item box-size-L">
                                <div class="portfoliobox box-size-L">
                                    <div class="picbox box-size-L">
                                        <a href="temp/big/keting.jpg" data-lightbox="gallery" data-title="客厅1"><img src="temp/Thumb/keting.jpg" style="max-width: inherit;max-height: inherit;width:246px;height:166px;margin-top: -20px;"></a>
                                    </div>
                                    <div style="margin-top: -20px;"><span style="padding-left: 20px;">客厅</span></div>
                                </div>
                            </li>
                            <li class="item box-size-M">
                                <div class="portfoliobox box-size-M">
                                    <div class="picbox box-size-M">
                                        <a href="temp/big/keting.jpg" data-lightbox="gallery" data-title="客厅1"><img src="temp/Thumb/keting.jpg" style="max-width: inherit;max-height: inherit;width:212px;height:142px;margin-top: -20px;"></a>
                                    </div>
                                    <div style="margin-top: -20px;"><span style="padding-left: 10px;">客厅</span></div>
                                </div>
                            </li>
                            <li class="item box-size-S">
                                <div class="portfoliobox box-size-S">
                                    <div class="picbox box-size-S">
                                        <a href="temp/big/keting.jpg" data-lightbox="gallery" data-title="客厅1"><img src="temp/Thumb/keting.jpg" style="max-width: inherit;max-height: inherit;width:160px;height:107px;margin-top: -20px;"></a>
                                    </div>
                                    <div style="margin-top: -20px;"><span style="padding-left: 15px;">客厅</span></div>
                                </div>
                            </li>
                        </ul>
                    </div>
            ...
            success: function (data) {
                ...
                if(data.error == 0){
                	$("#pictureUL").append(
                            ...
                            +'</div>'
                            +'<input type="text" class="input-text hidden" name="pictureId" value="'+data.picId+'" id="pictureIds">'
                            +'</div>'
                            +'</li>');
                   layer.msg('[OK]上传成功', {icon: 1});
                   setTimeout(function(){
...
<!-- <script>
    ...
    <script>
       $(".portfolio-area").delegate("li .clo","click",function(){
           ...
           <%--alert(thisId);--%>
           $.ajax({
               url:"<%=request.getContextPath()%>/back/oCFossil/deletePic.do",
               type:"post",
               data:{
                   picId:thisId
               },
