...
<form class="layui-form" id="newForm">
	<div class="layui-col-xs8" style="padding-right: 20px;">
		<div class="layui-form-item layui-row layui-col-xs12">
			...
			<input type="text" class="layui-input inputText" lay-verify="required" placeholder="请输入展览标题" id="headline" name="headline" style="width:100%;">
	...
	<div class="layui-col-xs4" style="padding-left: 20px;">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
		    <div class="layui-input-block" style="margin-left: 1px;">
		      <input id="radioOne" type="radio" name="exhibitionType" value="1" checked="checked" title="常设展览" lay-filter="type">
		      <input id="radioTwo" type="radio" name="exhibitionType" value="0" title="临时展览" lay-filter="type">
		    </div>
		</div>
		<div id="exhibitionTimediv" class="hide">
			...
			<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
				<div class="layui-input-inline">
					  <input type="text" class="layui-input" id="exhibitionTime" name="exhibitionTime" placeholder="选择展期 " style="width:300px;">
				 </div>
	        </div>
        </div>	
        <div class="layui-form-item layui-row layui-col-xs12" style="margin-top: 10px;">
		...
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<input type="text" class="layui-input inputText" lay-verify="required"  id="vipcurl" name="vipcurl" style="width:300px;">
		</div>
		<div class="layui-form-item layui-row layui-col-xs12" style="margin-top: 10px;">
			<label><b>展览地址</b></label>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<input type="text" class="layui-input inputText" lay-verify="required"  id="vimoveurl" name="vimoveurl" style="width:300px;">
		</div>	
	</div>
</form>
...
layui.use(['form','layer','laydate','upload'],function(){
    ...
    var saveFunction = function(){    	
    	$.ajax({
            url:"<%=request.getContextPath() %>/spreadtrum/save.do",
