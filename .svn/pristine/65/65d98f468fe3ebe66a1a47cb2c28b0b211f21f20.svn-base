 ...
 <form id="newForm" class="layui-form">
 		<div class="layui-form-item layui-row layui-col-xs12">
			...
			<div class="layui-input-block">
				<input onblur="blurName()" type="text" class="layui-input" lay-verify="required" placeholder="请输入组织名称" id="nameNew" name="name" value="" style="width:200px">
			</div>
		</div>
        <div class="layui-form-item layui-row layui-col-xs12">
			...
			<div class="layui-input-block userSex">
				...
				<input type="radio" name="orgTypeId" value="3" title="博物馆" checked>
...
$(function(){	
	layui.use(['form','layer'],function(){
	    ...
	    form.on("submit(addUser)",function(data){
	    	$.ajax({
	            url:appName+"/organization/museum/saveInfo.do",
