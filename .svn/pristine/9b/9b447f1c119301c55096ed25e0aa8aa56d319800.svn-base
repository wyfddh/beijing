...
<div class="layui-col-xs4" style="padding-left: 30px;">
	...
	<!-- <div class="docs-toggles" style="margin-top: 30px;">
		...
		<label class="radio-inline" style="margin-left: 20px;">
	        <input type="radio" id="aspectRatio1" name="aspectRatio" value="1.3333333333333333" title="【普通】4:3" checked>&nbsp;【4:3】普通文章
		</label><br>
		<label class="radio-inline" style="margin-left: 20px;">
        	<input type="radio" id="aspectRatio2" name="aspectRatio" value="0.75" title="【学术期刊】3:4">&nbsp;【3:4】学术期刊/专家舞台
		</label><br>
		<label class="radio-inline" style="margin-left: 20px;">
...
<script type="text/javascript">
    $(".confirm").click(function () {
        ...
        $.ajax({
            url: '<%=request.getContextPath() %>/attach/cutPicture.do?projectName=museumbaseInfo',
            type: "post",
            data: formData,
            dataType: "json",
            async: false,
