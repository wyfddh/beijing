...
<form class="layui-form" id="newForm">
	...
	<div class="layui-col-xs8" style="padding-right: 20px;">
		<div class="layui-form-item layui-row layui-col-xs12">
			<input type="text" class="layui-input inputText" lay-verify="required" placeholder="专家姓名" value="${article.title }" id="title" name="title" style="width:100%;">
			<textarea type="text" class="layui-textarea textarea" placeholder="这里输入出版图书" lay-verify="required" value="" name="content" id="content" style="width:100%;resize:none;height: 550px;">${article.content }</textarea>
...
<!-- 			<button type="button" lay-submit class="layui-btn layui-btn-danger" lay-filter="publish" id="publish">发布</button> -->
		...
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<textarea type="text" class="layui-textarea textarea sy" onkeyup="checkLength(this);" lay-verify="required" placeholder="这里输入基本信息" value="${article.description }" name="description" id="description" row="3" style="width:95%;resize:none;">${article.description }</textarea>
