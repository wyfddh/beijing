    ...
    <div class="layui-col-xs12" style="padding-right: 20px;padding-left: 20px;">
        <div class="layui-form-item layui-row layui-col-xs12">
           ...
           <div class="layui-input-inline">
                <input type="text" class="layui-input inputText" lay-verify="required" placeholder="请输入虚拟展厅标题"  id="viname" name="viname" style="width:350px;">
           </div>
           </div>
        </div>
        ...
        <div class="layui-form-item layui-row layui-col-xs12">
            ...
            <label class="layui-form-label">标题图</label>
                <div class="layui-input-inline">
                <div id="showImg" style="width: 95%;height: 110px;display: none;margin-bottom: 10px;"><a onclick="deleteImg()" href="javascript:void(0);" title="点击删除"><img id="titleImgShow" style="max-height: 100%;max-width: 100%;" src="" ></a></div>
...
<!--         <div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;width:95%;"> -->
        ...
        <div class="layui-form-item" >
            <div class="layui-inline">
	            ...
	            <div class="layui-input-inline">
	                <input type="text" class="layui-input inputText" lay-verify="required"  id="vipcurl" name="vipcurl" style="width:350px;">
	            </div>
            </div>
        </div>
        <div class="layui-form-item">
		    ...
		    <div class="layui-input-inline">
		      <input type="text" class="layui-input inputText" lay-verify="required"  id="vimoveurl" name="vimoveurl" style="width:350px;">
		    </div>
		 </div>        
        <div class="layui-form-item layui-row layui-col-xs12" style="margin-top: 10px;height:100px;">
            <label class="layui-form-label">简介</label>
            <div class="layui-inline">
	            <textarea placeholder="请输入内容" onkeyup="checkLength(this);" placeholder="这里输入简介" value="" name="viintro" id="viintro" class="layui-textarea" style="width:350px;min-height:100px;"></textarea>
	            <div>                     
...
layui.use(['form','layer','laydate','upload'],function(){
    ...
    var saveFunction = function(){    	
    	$.ajax({
            url:"<%=request.getContextPath() %>/virtual/save.do",
