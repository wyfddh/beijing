 ...
 */
@Entity
@Table(name = "mip_open_culturalrelic_info_static")
@GenericGenerator(name="Generator", strategy="com.tj720.mip.framework.IdGenerator")
public class MipOpenCulturalrelicInfoStatic extends BaseModel implements Serializable {
	...
	public MipOpenCulturalrelicInfoStatic(String id, String createTime, byte status, int sequence, String fpic, String name) {
		super();
		this.id = id;
	...
	public MipOpenCulturalrelicInfoStatic(String id, String pictureIds){
		this.id = id;
	 ...
	 */
	public MipOpenCulturalrelicInfoStatic(String id,String fpic,String name) {
		super();
		this.id = id;
		this.fpic = fpic;
		this.name = name;
	 ...
	 *    </pre>    
	 */
	public MipOpenCulturalrelicInfoStatic() {
		super();
	}
	public MipOpenCulturalrelicInfoStatic(String id,String collectionType, int clickCounts) {
		super();
		this.id = id;
		this.collectionType = collectionType;
		this.clickCounts = clickCounts;
	...
	public MipOpenCulturalrelicInfoStatic(String id, String name, String collectionType, int clickCounts) {
		super();
		this.id = id;
		this.name = name;
		this.collectionType = collectionType;
	...
	public MipOpenCulturalrelicInfoStatic(String id, String pictureIds, String collectionUnit, String gsNo,
