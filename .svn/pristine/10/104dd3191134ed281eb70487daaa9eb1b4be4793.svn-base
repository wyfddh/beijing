...
<body>
	...
	<section class="Hui-article-box">
		<form action="/admin/back/oCCollection/info.do" method="get" id="form">
			<div class="hide">   
	        	每页显示条数:&nbsp; 
							...
							<li>
								...
								<ul class="thirdTitle">
									<li class="zj_public_wenwu" style="margin-right:-14px">
										<a style="border:0;background:#ffffff;color:#2a9bcf;" href="/admin/back/oCCollection/info.do" rel="/mip/back/oCCollection/info.do" title="文物藏品类别">
	...
	<!--/请在上方写此页面业务相关的脚本-->
		...
		$(".zj_checkList_save").unbind().on("click",function(){
			...
			$.ajax({
	            ...
	            url : "/admin/back/oCCollection/reviewObject.do",
