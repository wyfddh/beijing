...
<body>
	<article class="page-404 minWP text-c">
		<p class="error-title"><i class="Hui-iconfont va-m">&#xe688;</i>
			<span class="va-m">No Auth</span>
		</p>
		<p class="error-description">不好意思，您当前账号<font color="red">没有</font>此页面的的<font color="red">访问权限</font></p>
		<p class="error-info">您可以：
			<a href="javascript:;" onclick="history.go(-1)" class="c-primary">&lt; 返回上一页</a>
			<span class="ml-20">|</span>
			<a href="<%=request.getContextPath() %>/toLogin.do" class="c-primary ml-20">去登录 &gt;</a>
		</p>
	</article>
</body>
</html>