...
public final class Globals {
	...
	public static Short Log_Leavel_ERROR=3;
	 ...
	 static{
		 String button_authority_centusoft = ResourceUtil.getConfigByName("button.authority.zxlhdata");
		 if("true".equals(button_authority_centusoft)){
	 ...
	 public static String SESSION_MENU_DATA_AUTHOR_RULES ="SESSION_MENU_DATA_AUTHOR_RULES";
	 /**
	  * 数据权限 - 菜单数据规则sql
	  */
	 public static String MENU_DATA_AUTHOR_RULE_SQL ="MENU_DATA_AUTHOR_RULE_SQL";
	 public static String SESSION_MENU_DATA_AUTHOR_RULE_SQL ="SESSION_MENU_DATA_AUTHOR_RULE_SQL";
}
