    ...
    <div id="content_warp">
    	...
    	<div style="margin-bottom: 36px !important;">
	        <div class="button_wrap zj_edit_btn">
	            ...
	            <a class="qx" style="border: 1px solid #2a9bcf;" href="javascript:history.go(-1);">
            ...
            <div id="tab-category" class="HuiTab">
                ...
                <div class="tabCon">
					...
					<div class="zj_edit_audio">
						<c:choose>
							<c:when test="${not empty collection.fAudio && collection.fAudio != '' }">
							...
							<c:otherwise>
								<div class="zj_edit_message">
									<span>
										<img src="<%=request.getContextPath() %>/back/lib/Tags/img/x.png" alt="" style="width: 2%; vertical-align:middle;"></img>当前无音频
									</span>
								</div>
							</c:otherwise>
						</c:choose>
