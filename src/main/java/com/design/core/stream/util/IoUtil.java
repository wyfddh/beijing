package com.design.core.stream.util;
...
import com.design.core.stream.servlet.FormDataServlet;
import com.design.core.stream.servlet.Range;
import com.design.core.stream.servlet.StreamServlet;
...
public class IoUtil {
	 ...
	 * @throws Exception 
	 */
	public static File getTokenedFile(String key) throws Exception {
	...
	public static void storeToken(String key) throws Exception {
		if (key == null || key.isEmpty())
			return;
