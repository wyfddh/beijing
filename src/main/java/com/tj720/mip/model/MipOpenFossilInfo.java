...
public class MipOpenFossilInfo extends BaseModel implements Serializable {
	 ...
	 *    </pre>    
	 */
	public MipOpenFossilInfo(String id,String collectionType, int clickCounts) {
		super();
		this.id = id;
		this.collectionType = collectionType;
		this.clickCounts = clickCounts;
	...
	public MipOpenFossilInfo(String id, String name, String collectionType, int clickCounts) {
		super();
		this.id = id;
		this.name = name;
		this.collectionType = collectionType;
