...
public class DateUtil {  
    ...
    public static int getIntervalHours(String date, String otherDate) {  
        return getIntervalHours(StringToDate(date), StringToDate(otherDate));  
    }  
     ...
     * @return 相差小时数。如果失败则返回-1 
     */  
    public static int getIntervalHours1(Date date, Date otherDate) {  
        int num = -1;  
        Date dateTmp = date;  
    ...
    public static int getIntervalMinutes(String date, String otherDate) {  
        return getIntervalMinutes(StringToDate(date), StringToDate(otherDate));  
    }  
