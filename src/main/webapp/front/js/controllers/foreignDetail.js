angular.module("foreignDetail",[])
    .controller("goForeignDetail",function($scope,$http,$rootScope,$stateParams){
        ...
        $(function(){
            ...
            var type= 2;
            // dropload
            var dropload = $('.foreignDetail-top .down-list').dropload({
                domUp : {
                ...
                loadDownFn : function(me){
                    ...
                    $scope.loadMore = function () {
                        $http.get('../otherSpreadtrum/getReceptionSpreadtrum.do?currentPage='+page+'&type='+type)
                            .success(function(data){
                                ...
                                for(var i = 0; i < data.data.length; i++){
                                    ...
                                    result += '<div class="list">'
                                        +'<a class="item item-thumbnail-left" href="#/foreignDetailContent/'+data.data[i].id+'">'
                                ...
                                // 为了测试，延迟1秒加载
                                setTimeout(function(){
                                    $('.foreignDetail-top .down-list').append(result);
                                    // 每次数据加载完，必须重置
                                    dropload.resetload();
                                },1000);
                            }).
