...
eval("var oSelectListMain = document.getElementById('selectListMain');");

eval("var  oClearListMain = $('#queryModel_Main11_').find('#clearList_Main11_');");



var oCustext1 = document.getElementById('custext1');
var oCustext2 = document.getElementById('custext2');
eval("var aItemTxt = oSelectListMain.getElementsByTagName('a');");
var isCusPrice = false;//是否自定义价格
var radioVal = '';

eval("oSelectListMain").onclick = function(e, a) {
            ...
            if (oPrevInput && oPrevInput.getAttribute('type').toUpperCase() == 'RADIO') { //radio
             ...
             var typegroupId=tag.getAttribute('typegroupId');
	   		 ...
	   		 if(value!=null&&value!=""){
	   			...
	   			eval("oClearListMain").append(infor);
    }
		}
    }
...
$("#clearList_Main11_").on("click", "em", function () {
...
$("#selectListMain").on("blur", ".sl-inputtext-ss", function () {
...
//  $(oSelectList).find('input').attr('checked',false);
  ...
  isCusPrice = false;
  okSelect.length = 0;
  $(eval("oSelectListMain")).trigger('click', 1);
