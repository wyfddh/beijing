                ...
                select: function() {
                    ...
                    f.each(function(e, l) {
                        ...
                        var v = "string" == typeof s.attr("lay-search"),
                            ...
                            m = i(['<div class="layui-unselect ' + a + (o ? " layui-select-disabled" : "") + '">', '<div class="' + n + '"><input type="text" placeholder="' + p + '" value="' + (d ? f.html() : "") + '" ' + (v ? "" : "readonly") + ' class="layui-input layui-unselect' + (o ? " " + c : "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (s.find("optgroup")[0] ? " layui-select-group" : "") + '">' + function(e) {
                                var i = [];
