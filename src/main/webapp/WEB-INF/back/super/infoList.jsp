    ...
    <div class="Hui-article">
            ...
            <div style="min-width: 1020px;padding-left: 30px;padding-right:30px;margin-top: 30px;"> 
                <table class="table">
                    ...
                    <tr class="text-c">
                        <th width="100">序号</th>
                        <th width="100">上报单位</th>
                        <th width="300">上报时间</th>
                        <th width="300">操作</th>
                    </tr>
                    </thead>
                    <tbody>
	                   <c:forEach items="${register}" var="info" varStatus="status">
								<tr class="text-c">
									<td>${status.index + 1}</td>
									<td>${info.museumName}</td> 
									<td>
									...
									<!-- 预览的地址栏需要修改 -->
									<td class="td-manage">
										<a title="查看" href="<%=request.getContextPath() %>/registerInfo/getRegister.do?id=${info.id }" href="javascript:;">
