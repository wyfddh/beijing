...
<head>
    ...
    <meta name="description" content="">
     ...
     <style>
        ...
        #coverVideo{
            width: 70%;height: 400px;background: rgba(0,0,0,0.7);position: fixed;left: 15%;top:20%;border:5px solid lightslategray;min-width: 800px;display: none;
        }
        #coverAudio{
            width: 70%;height: 400px;background: rgba(0,0,0,0.7);position: fixed;left: 15%;top:20%;border:5px solid lightslategray;min-width: 800px;display: none;
        }
...
<section class="Hui-article-box section_box">
    <div id="content_warp">
    	<div style="margin-bottom: 36px !important;">
			<span class="zj_edit_title">编辑化石</span>
                    ...
                    <div class="zj_edit_content">
                    	...
                    	<div class="col-xs-12" style="padding: 0;margin-bottom: 25px;">
                    		<%-- <div class="col-md-3 col-xs-12 col-sm-6">
			                    <img id="hsPic" src="<%=request.getContextPath() %>/back/images/default_img.png" class="size-XXL">
                    		</div> --%>
                    		<div class="col-md-3 col-xs-12 col-sm-6">
	                        ...
	                        <div class="col-md-5 col-xs-12 col-sm-6" style="float: right;padding:0 0 0 24px;">
	                            ...
	                            <div class="formControls_spe">
	                            	<select name="yearTypeEon" class="select yearType" style="width: 58px;padding:4px;border-radius: 5px;">
									...
									<select name="yearTypeEra" class="select yearType" style="width: 57px;padding:4px;border-radius: 5px;">
									...
									<select name="yearTypeEpoch" class="select yearTypeEpoch" style="width: 57px;padding:4px;border-radius: 5px;">
        ...
        <form id="uploadFormVideo" enctype="multipart/form-data" method="post" >
	         <div id="coverVideo">
	             ...
	             <div class="row cl pt-20 pl-30 col-offset-1" style="padding-top: 120px;">
	                 <label class="col-xs-4 col-sm-3 text-r col-md-2 c-white lig" id="cTitle">请选择视频：</label>
	                 <div class="formControls col-xs-8 col-sm-9 col-md-8">
        ...
        <form id="uploadFormAudio" enctype="multipart/form-data" method="post" >
	         <div id="coverAudio">
	             <a href="javascript:;" class="Hui-iconfont c-white btn btn-danger close">&#xe6a6;</a>
	             <div class="row cl pt-20 pl-30 col-offset-1" style="padding-top: 120px;">
	                 <label class="col-xs-4 col-sm-3 text-r col-md-2 c-white lig" id="cTitle">请选择音频：</label>
	                 <div class="formControls col-xs-8 col-sm-9 col-md-8">
		                 <span class="btn-upload form-group">
           ...
           $("#saveTabOne").click(function(){
                if($(".mingcheng").val() == ""){
                    ...
                    return false;
                     ...
                     $.ajax({
                         url : "<%=request.getContextPath() %>/collectionsFossil/addOrUpdate.do",
                         type : "post",
                         data :  data,
                         dataType : "json",
...
$(function(){
	...
	$(".btnMain").click(function(){
		...
		$.ajax({
			url : "<%=request.getContextPath()%>/collectionsFossil/setMain.do",
			type : "post",
...
$(function(){
    $('.yearType').change(function(){
        ...
        $.ajax({
            url:"<%=request.getContextPath() %>/back/fCFossil/sltYearType.do",
            data:{pid:pid},
            type:"POST",
    ...
    <script>
        ...
        $(".portfolio-area").delegate("li .clo","click",function(){
            ...
            <%--alert(thisId);--%>
            $.ajax({
                url:"<%=request.getContextPath() %>/collectionsFossil/deletePic.do",
                type:"post",
                data:{
                    picId:thisId
                },
