...
<body class="childrenBody">
		...
		<div class="layui-tab-content">
						...
						<form class="layui-form" id="formSearch1" method="post">
							...
							<div class="layui-row">
								<div class="layui-inline" style="margin-left: 25px">
									...
									<button type="button" style="margin-left: 17px" id="batchRemove"
                                        class="layui-btn ">批量移除</button> 
								</div>
							</div>
			...
			<div class="layui-tab-item">
                ...
                <script type="text/html" id="openCollectionsListTableBar">
                       ...
                       <a class="layui-btn layui-btn-xs" lay-event="remove">从馆际公开库移除</a>
                      </c:if>
                      <c:if test="${!(level eq 1)}">
                       <a class="layui-btn layui-btn-xs {{checkAuth("${orgId}",d.collectionUnit) ? 'layui-hide' : '' }}" lay-event="remove">从馆际公开库移除</a>
                      </c:if>
                </script>
	...
	<script type="text/javascript"
		src="<%=request.getContextPath() %>/back/js/collect/collections/openCollectionsList.js"></script>
