...
<section class="Hui-article-box section_box">
    <div id="content_warp">
    	<div style="margin-bottom: 36px !important;">
    		<span class="zj_detail_title">查看藏品</span>
		</div>
    	<div style="margin-bottom: 36px !important;">
	        <div class="button_wrap zj_edit_btn">
	        	<c:if test="${fn:contains(sessionScope.user.authStr,'SystemAdmin')==true and type eq '1'}">
					<c:if test="${fn:contains(sessionScope.user.orgTypeId,1)  and collection.status eq '3'}">
					...
					<c:if test="${fn:contains(sessionScope.user.orgTypeId,3) and collection.status eq '2'}">
                ...
                <div class="tabCon">
                    ...
                    <div class="zj_detail_content">
                    	<div class="col-xs-12" style="padding: 0;margin-bottom: 25px;">
	                        ...
	                        <div class="col-md-5 col-xs-12 col-sm-6" style="float: right;padding:0 0 0 24px;margin-bottom: 9px;">
	                            ...
	                            <div class="formControls_spe">
	                            	<c:if test="${'1' eq collection.collectionLevel }">
                                		<input type="text" class="input-text" value="一级" readonly="readonly">
	                                </c:if>
	                                <c:if test="${'2' eq collection.collectionLevel }">
	                                	<input type="text" class="input-text" value="二级" readonly="readonly">
	                                </c:if>
	                                <c:if test="${'3' eq collection.collectionLevel }">
	                                	<input type="text" class="input-text" value="三级" readonly="readonly">
	                                </c:if>
	                                <c:if test="${'4' eq collection.collectionLevel }">
	                                	<input type="text" class="input-text" value="一般" readonly="readonly">
	                                </c:if>
	                                <c:if test="${'5' eq collection.collectionLevel }">
	                                	<input type="text" class="input-text" value="未定级" readonly="readonly">
	                                </c:if>
	                            </div>
	                        </div>                  		
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;margin-bottom: 9px;">
	                        ...
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;">
	                            ...
	                            <div class="formControls_spe ">
	                                <input type="text" class="input-text" value="${mipOrganization }" readonly="readonly" disabled="disabled">
	                            </div>
	                        </div>  
	                        <div class="col-md-5 col-xs-12 col-sm-6" style="float: right;padding:0 0 0 24px;">
	                            ...
	                            <div class="formControls_spe">
		                            <input type="text" class="input-text" value="${yearType }" readonly="readonly">
	                            </div>
	                        </div>	                       	
                    	</div>
                    	...
                    	<div class="col-xs-12" style="margin-bottom: 50px;">
	                        ...
	                        <textarea class="textarea" readonly="readonly">${collection.description }</textarea>
	                    </div>
						...
						<div class="col-xs-12" style="margin-bottom: 20px;">
	                        <div class="col-md-4 col-xs-12 col-sm-6" >
	                            ...
	                            <div class="formControls">
		                            <input type="text" class="input-text" value="${collection.gsTextureCategory }" readonly="readonly">
	                            </div>
	                        </div>							
	                    	<div class="col-md-4 col-xs-12 col-sm-6">
	                            <label class="form-label label_1">质地：</label>
	                            <div class="formControls ">
	                                <input type="text" class="input-text" value="${collection.gsTexture }" readonly="readonly">
	                            </div>
	                   		</div>						
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;">
	                            <label class="form-label label_3" >质地子类别:</label>
	                            <div class="formControls"  style="width: 189px;">
	                            	<input type="text" class="input-text" value="${collection.gsTextureSubcategories }" readonly="readonly">
	                            </div>
	                        </div>						
						</div>                   	
                    	...
                    	<div class="col-xs-12" style="margin-bottom: 20px;">
							...
							<div class="col-md-4 col-xs-12 col-sm-6">
						        ...
						        <div class="formControls">
						            <input type="text" class="input-text" value="${collection.gsWidth }" readonly="readonly">
						        </div>
							</div>
							<div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;">
						        <label class="form-label label_3">通高:</label>
						        <div class="formControls" style="width: 189px;">
						            <input type="text" class="input-text" value="${collection.gsHeight }" readonly="readonly">
						        </div>
							</div>							
						</div>
                    	...
                    	<div class="col-xs-12" style="margin-bottom: 20px;">
	                        <div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class="formControls ">
	                                <input type="text" class="input-text" value="${collection.endResidueLevel }" readonly="readonly">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>	                        
	                        <div class="col-md-4 col-xs-12 col-sm-6">
                    	...
                    	<div class="col-xs-12" style="margin-bottom: 20px;">
	                    	...
	                    	<div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class="formControls ">
	                                <input type="text" class="input-text" value="${collection.gsAuthor }" readonly="readonly">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>
	                        <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;">
	                            ...
	                            <div class="formControls " style="width: 189px;">
	                                <input type="text" class="input-text" value="${collection.gsVersion }" readonly="readonly">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>
	                    </div>
                    	...
                    	<div class="col-xs-12" style="margin-bottom: 20px;">
	                    	<div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class="formControls ">
	                                <input type="text" class="input-text" value="${collection.massRange }" readonly="readonly">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>
	                        <div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class="formControls">
	                                <input type="text" name="mass" class="input-text" value="${collection.mass }" readonly="readonly" style="width: 50px;float: left;">
	                                <input type="text" class="input-text" value="${collection.massUnit }" readonly="readonly" style="width:85px;float: right;padding: 4px 0;">
	                            </div>
	                        </div>						
	                    	 <div class="col-md-4 col-xs-12 col-sm-6" style="padding: 0;">
	                            <label class="form-label label_3">完残状况：</label>
	                            <div class="formControls " style="width: 189px;">
	                                <input type="text" class="input-text" value="${collection.endResidualCondition }" readonly="readonly">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>						
						</div>
						<div class="col-xs-12" style="margin-bottom: 20px;">
	                       	<div class="col-md-4 col-xs-12 col-sm-6">
	                            ...
	                            <div class="formControls ">
	                                <input type="text" class="input-text" value="${collection.gsKeepOnFile }" readonly="readonly">
	                            </div>
	                            <div class="col-3"></div>
	                        </div>						
	                    	 <div class="col-md-4 col-xs-12 col-sm-6">
	                        ...
	                        <div class="col-md-4 col-xs-12 col-sm-6"  style="padding: 0;">
	                            ...
	                            <div class="formControls " style="width: 189px;">
	                                <input type="text" class="input-text" value="${collection.assessor }" readonly="readonly" style="width:200px;">
	                            </div>
	                        </div>
                    ...
                    <div>
                        ...
                        <div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="formControls col-xs-4">
                                <input type="text" class="input-text" value="${collection.mass }" readonly="readonly">
                            </div>
                            <div class="formControls col-xs-2">
                                <input type="text" class="input-text" value="${collection.massUnit }" readonly="readonly">
                            </div>
                            <div class="col-3"></div>
                        </div>
                        <div class="row col-md-4 col-xs-12 col-sm-6">
                    ...
                    <div>
                        ...
                        <<%-- div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="formControls col-xs-6">
                                <input type="text" class="input-text" value="${collection.createTime }" readonly="readonly">
                            </div>
                            <div class="col-3"></div>
                        </div>
                       <div class="row col-md-4 col-xs-12 col-sm-6">
                            ...
                            <div class="formControls col-xs-6">
                                <input type="text" class="input-text" value="${collection.submitTime }" readonly="readonly">
                            </div>
                            <div class="col-3"></div>
                        </div> --%>
                    </div>
                    ...
                    <div>
                        <div class="row cl col-xs-12" style="margin-left: 1.5rem;">
                            ...
                            <div class="formControls col-xs-10">
                                <textarea class="textarea" readonly="readonly">${collection.remark }</textarea>
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class = "row col-md-12 col-xs-12 col-sm-12">
                            <div class="row col-md-4 col-xs-12 col-sm-6">
                                ...
                                <div class="form-label col-xs-6">
                                    <div class="signl_check">
                                        <div class="radio-box">
                                            <input type="radio" id="radio-3" name="demo-radio2" <c:if test="${'2' eq collection.isOpen}">checked</c:if> disabled="disabled">
                                            <label for="radio-1">是</label>
                                        </div>
                                        <div class="radio-box">
                                            <input type="radio" id="radio-4" name="demo-radio2" <c:if test="${'1' eq collection.isOpen}">checked</c:if> disabled="disabled">
                                            <label for="radio-2">否</label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <!-- <div style="clear: both"></div>
	                    <div class="button_wrap">
	                         <span class="btn-upload">
	                             <a href="javascript:void(0);" class="btn" style="margin-right: 1.5rem;background: #369593;color:#ffffff">保存</a>
	                         </span>
	                        <span class="btn-upload">
