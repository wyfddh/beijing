...
<form class="layui-form" id="newForm">
	<div class="layui-col-xs8" style="padding-right: 20px;">
		<div class="layui-form-item layui-row layui-col-xs12">
			...
			<input type="text" class="layui-input inputText" lay-verify="required" placeholder="请输入讲座标题" id="activityName" name="activityName" style="width:100%;">
	...
	<div class="layui-col-xs4" style="padding-left: 20px;">
		...
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<div class="layui-input-inline" style="width:300px;">
				  <input type="text" class="layui-input inputText" lay-verify="required" placeholder="请输入地址"id="activityPlace" name="activityPlace">
			 </div>
        </div>
        <div class="layui-form-item layui-row layui-col-xs12" >
			<label><b>主讲人</b></label>
		...
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<div class="layui-input-inline" style="width:300px;">
				  <input type="text" class="layui-input inputText" lay-verify="required" id="speaker" name="speaker">
			 </div>
        </div>
        <div class="layui-form-item layui-row layui-col-xs12">
		...
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<div class="layui-input-inline" style="width:300px;">
				  <input type="text" class="layui-input inputText" lay-verify="required" id="topics" name="topics">
			 </div>
        </div>
		...
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<div class="layui-input-inline" style="width:300px;">
				<input type="text" class="layui-input inputText" lay-verify="required" id="gatherTime" name="gatherTime">
			 </div>
        </div> -->
