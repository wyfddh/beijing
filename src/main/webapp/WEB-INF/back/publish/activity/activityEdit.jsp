...
<form class="layui-form" id="newForm">
	<div class="layui-col-xs8" style="padding-right: 20px;">
		<div class="layui-form-item layui-row layui-col-xs12">
			...
			<input type="text" class="layui-input inputText" lay-verify="required" placeholder="请输入活动标题" id="activityName" name="activityName" value="${activity.activityName}" style="width:100%;">
	...
	<div class="layui-col-xs4" style="padding-left: 20px;">
		...
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<div class="layui-input-inline" style="width:300px;">
				  <input type="text" class="layui-input inputText" lay-verify="required" value="${activity.activityPlace}" placeholder="请输入活动地址"id="activityPlace" name="activityPlace">
			 </div>
        </div>
        <div class="layui-form-item layui-row layui-col-xs12">
		...
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<textarea type="text" class="layui-textarea textarea sy" onkeyup="checkLength(this);" placeholder="这里输入描述" value="" name="module" id="module"  style="width:300px;height:100px;resize:none;">${activity.module}</textarea>
