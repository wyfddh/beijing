...
<form class="layui-form" id="newForm">
	<div class="layui-col-xs8" style="padding-right: 20px;">
		<div class="layui-form-item layui-row layui-col-xs12">
		    <input type="hidden" name="activityCategory" id="activityCategory" value="2"/>  
		    <input type="hidden" id="id" name="id" value="${activity.id}"> 
			<input type="hidden" id="pictureId" name="pictureId" value="${activity.pictureId}">
			<input type="text" class="layui-input inputText" lay-verify="required" placeholder="请输入讲座标题" id="activityName" name="activityName" value="${activity.activityName}" style="width:100%;">
			<script id="editorCh" type="text/plain" style="width:100%;" name="content">${activity.content}</script>			
		</div>
		<div class="layui-form-item layui-row layui-col-xs12" >
	...
	<div class="layui-col-xs4" style="padding-left: 20px;">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
		<c:if test="${not empty activity.pictureId }" var="imgIsNotNull">
			<div id="showImg" style="width: 95%;height: 100px;margin-bottom: 10px;"><a onclick="deleteImg()" href="javascript:void(0);" title="点击删除"><img id="titleImgShow" style="max-height: 100%;max-width: 100%;" src="${activity.pictureId}" ></a></div>
		</c:if>
		<c:if test="${!imgIsNotNull }">
			<div id="showImg" style="width: 95%;height: 100px;display: none;margin-bottom: 10px;"><a onclick="deleteImg()" href="javascript:void(0);" title="点击删除"><img id="titleImgShow" style="max-height: 100%;max-width: 100%;" src="${activity.pictureId}" ></a></div>
		</c:if>
			<button type="button" class="layui-btn layui-btn-radius layui-btn-primary" id="uploadImg"><i class="layui-icon">&#xe67c;</i>上传标题图</button>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12" >
			<label><b>讲座时间</b></label>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<div class="layui-input-inline" style="width:300px;">
				  <input type="text" class="layui-input" id="activityTime" name="activityTime" value="${activity.activityTime}" placeholder="选择时间 ">
			 </div>
        </div>
         <div class="layui-form-item layui-row layui-col-xs12" >
			<label><b>地址</b></label>
		...
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<div class="layui-input-inline" style="width:300px;">
				  <input type="text" class="layui-input inputText" lay-verify="required" value="${activity.activityPlace}" placeholder="请输入地址"id="activityPlace" name="activityPlace">
			 </div>
        </div>
        <div class="layui-form-item layui-row layui-col-xs12" >
			<label><b>主讲人</b></label>
		...
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<div class="layui-input-inline" style="width:300px;">
				  <input type="text" class="layui-input inputText" value="${activity.speaker}" lay-verify="required" id="speaker" name="speaker">
			 </div>
        </div>
        <div class="layui-form-item layui-row layui-col-xs12">
			<label><b>讲座主题</b></label>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<div class="layui-input-inline" style="width:300px;">
				  <input type="text" class="layui-input inputText" lay-verify="required" value="${activity.topics}" id="topics" name="topics">
			 </div>
        </div>
       <%--  <div class="layui-form-item layui-row layui-col-xs12" style="margin-top: 10px;">
			<label><b>集合时间</b></label>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<div class="layui-input-inline" style="width:300px;">
				<input type="text" class="layui-input inputText" lay-verify="required" value="${activity.gatherTime}" id="gatherTime" name="gatherTime">
			 </div>
        </div> --%>
...
layui.use(['form','layer','laydate','upload'],function(){
    ...
    var saveFunction = function(){    	
    	$.ajax({
            url:"<%=request.getContextPath() %>/activityAdmin/update.do",
