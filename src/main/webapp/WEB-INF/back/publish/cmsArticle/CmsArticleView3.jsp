	...
	<div class="layui-col-xs12" style="padding-left: 20px;">
		...
		<div class="layui-form-item layui-row layui-col-xs12">
			<c:if test="${not empty file_realFileName }" var="pdfIsNotNull">
				<div id="showFile">
					<a class="layui-btn layui-btn-radius layui-btn-primary" onclick="downFile('${file_resultPath }', '${file_realFileName }')" title="点击下载期刊文件"><i class="layui-icon">&#xe66e;</i>${file_realFileName }</a>
				</div>
			</c:if>
		</div>
