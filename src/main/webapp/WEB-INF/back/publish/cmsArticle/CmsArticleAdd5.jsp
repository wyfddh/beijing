...
<form class="layui-form" id="newForm">
	...
	<input type="hidden" id="titleImageSrc" name="titleImageSrc" value="">
	<input type="hidden" id="pdfUrl" name="pdfUrl" value="">
	...
	<div class="layui-col-xs8" style="padding-right: 20px;">
		<div class="layui-form-item layui-row layui-col-xs12">
			<input type="text" class="layui-input inputText" lay-verify="required" placeholder="专家姓名" id="title" name="title" style="width:100%;">
			<textarea type="text" class="layui-textarea textarea" placeholder="这里输入出版图书" lay-verify="required" value="" name="content" id="content" style="width:100%;resize:none;height: 550px;"></textarea>
<!-- 			<script id="editorCh" type="text/plain" style="width:100%;" name="content"></script> -->
	...
	<div class="layui-col-xs4" style="padding-left: 20px;">
		<div class="layui-form-item layui-row layui-col-xs12" style="text-align: right;padding-right:20px;">
			...
			<button type="button" class="layui-btn layui-btn-primary" id="close" onclick="close();">关闭</button>
<!-- 			<button type="button" lay-submit class="layui-btn layui-btn-danger" lay-filter="publish" id="publish">发布</button> -->
		</div>
		
		<div class="layui-form-item layui-row layui-col-xs12">
			<label><b>专家头像</b></label>
		</div>
		<div class="layui-form-item layui-row layui-col-xs12">
			<div id="showImg" style="width: 95%;height: 200px;display: none;margin-bottom: 10px;"><a onclick="deleteImg()" href="javascript:void(0);" title="点击删除"><img id="titleImgShow" style="max-height: 100%;max-width: 100%;" src="" ></a></div>
			<button type="button" class="layui-btn layui-btn-radius layui-btn-primary" id="uploadImg"><i class="layui-icon">&#xe67c;</i>上传专家头像</button>
		</div>
		...
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<input type="text" class="layui-input inputText" placeholder="这里输入学术论文作者" value="" name="author" id="author" style="width:95%;">
		</div> -->
		...
		<div class="layui-form-item layui-row layui-col-xs12" style="vertical-align:middle;">
			<textarea type="text" class="layui-textarea textarea" onkeyup="checkLength(this);" placeholder="这里输入基本信息" lay-verify="required" value="" name="description" id="description" row="3" style="width:95%;resize:none;"></textarea>
...
layui.use(['form','layer','laydate','upload'],function(){
    ...
    var saveFunction = function(status){
    	...
    	$.ajax({
            url:"<%=request.getContextPath() %>/cmsArticel/save.do",
