...
<form class="layui-form" id="newForm">
	<div class="layui-form-item layui-row layui-col-xs12">
		...
		<div class="layui-input-block">
			<input type="text" class="layui-input inputText" lay-verify="required" placeholder="这里输入链接名称" id="title" name="title" style="width:300px">
		</div>
	</div>
	<div class="layui-form-item layui-row layui-col-xs12">
		<label class="layui-form-label">链接地址</label>
		<div class="layui-input-block">
			<input type="text" class="layui-input inputText" lay-verify="required|urlVerify" placeholder="这里输入链接地址" id="url" name="url" style="width:300px">
		</div>
	</div>
	<div class="layui-form-item layui-row layui-col-xs12">
		<label class="layui-form-label">链接图标</label>
		<div class="layui-input-block">
			<img id="iconImg" title="点击删除" src="" width="60px" height="60px" style="border: 1px black solid;display: none;cursor:pointer;">
