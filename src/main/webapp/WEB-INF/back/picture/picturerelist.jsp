...
<body>
            ...
            <div class="formControls col-xs-6 col-sm-4">
			    ...
			    <div id="progress" class="progress" style="width:100%!important" >
			        ...
			        <div>
					    ...
					    <p style="float:right;"><span>总文件数：</span><span id="totalcount"></span></p>
				    </div>
	...
	<script>
		$(function(){
			...
			$.ajax({
				url:"<%=request.getContextPath() %>/back/picture/restatus.do",
				type:'POST',
				data: {},
				datetype:'json',
				success:function(msg){
					...
					if(parseInt(msg.currentIndex)<parseInt(msg.count)){
			...
			$("#start").click(function(){
				...
				$.ajax({
					url:"<%=request.getContextPath() %>/back/picture/restart.do",
					data:data,
					type:'POST',
					datetype:'json',
					success:function(msg){
			...
			function show_status(msg){
				...
				$('#totalcount').html(msg.count);
				console.log(msg.currentIndex);
				console.log(msg.count);
				if(parseInt(msg.currentIndex)<parseInt(msg.count)){
					var progress=msg.currentIndex*100/msg.count;
					$('#progress .progress-bar').css(
				            'width',
				            progress + '%'
				     );
				}else if(parseInt(msg.count)==0){
					$('#progress .progress-bar').css(
				            'width', '0%'
				     );
				}else{
