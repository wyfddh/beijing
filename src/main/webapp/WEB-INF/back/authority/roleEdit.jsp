...
<form class="layui-form" id="form">
	...
	<div class="layui-form-item layui-row layui-col-xs12">
		...
		<div class="layui-input-block">
			<input type="text" class="layui-input inputText" lay-verify="required" placeholder="请输入角色名称" value="${role.roleName }" name="roleName" id="roleName" style="width:200px">
		</div>
	</div>
	<div class="layui-form-item layui-row layui-col-xs12">
	...
	<div class="layui-form-item layui-row layui-col-xs12">
		...
		<div class="layui-input-block">
			<textarea type="text" class="layui-textarea textarea" placeholder="请输入备注" value="${role.remark }" name="remark" id="remark" row="3" style="width:200px;resize:none;">${role.remark }</textarea>
		</div>
	</div>
...
layui.use(['form','layer'],function(){
    ...
    form.on("submit(save)",function(data){
    	...
    	$.ajax({
          	url:"<%=request.getContextPath() %>/role/roleEdit.do",
            data:$("#form").serialize(),
            type:"POST",
