				...
				<article class="cl pd-20 zj_wwlist_content">
					<div class="zj_wwlist_chose">
						...
						<div class="infoDiv">
								...
								<div class="pl-30">
									<div class="floatLeft overviewDiv" style="display:flex;">
										...
										<div class="floatRight ml-10 mr-20">
											<div  class="pt-10 pb-5 centerDiv">全省藏品总数</div>
									...
									<div class="floatLeft ml-10">
										<div class="overviewDiv pt-5 pb-5 mb-5 rightDiv">
											<label class="pl-10">全省新增藏品次数</label>
										...
										<div class="overviewDiv pt-5 pb-5 rightDiv">
											<label class="pl-10">全省编辑藏品次数</label>
							...
							<div class="mt-20 ml-20" id="showText">最近七天所有变更统计</div>
						</div>
						<div class="infoDiv">
...
<script type="text/javascript">
    ...
    function getAreaList(){
    	$.ajax({
            type : "post",
            async : true, //同步执行
            url : "/admin/trendsManage/getAreaList.do",
            dataType : "json", //返回数据形式为json
            success : function(result) {
            	if(result.success==1){
	            	$("#mipArea").html("");
    ...
    function showPie(){
         ...
         $.ajax({
             ...
             url : "/admin/trendsManage/showEchartPie.do",
             dataType : "json", //返回数据形式为json
             success : function(result) {
                 if (result) {
                     options.legend.data = result.legend;
