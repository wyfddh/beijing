        ...
        <form action="" method="get" class="form form-horizontal" id="form-collection-add">
            <div id="tab-category" class="HuiTab">
                ...
                <div class="tabCon">
                    ...
                    <!--备注开始-->
                   <%--  <div>
                        <div class="cl col-xs-12" style="margin-left: 1.5rem;">
                    ...
                    <%-- <div>
                        <div class = "col-md-12 col-xs-12 col-sm-12">
                            <div class="col-md-4 col-xs-12 col-sm-6">
                                <label class="form-label  fontgreen">是否公开：</label>
                                <div class="form-label ">
                    ...
                    <!--保存取消按钮开始-->
                   <!--  <div class="cl col-xs-10 col-sm-12 col-offset-1">
                    ...
                    <div class="cl">
                     ...
                     <div class="button_wrap" style="padding-left:115px;padding-top:30px;">
                         <span class="btn-upload c">
                             <a id="saveTabThree" class="btn btn-primary radius saveinfo saveTabTwoThree" style="margin-right: 1.5rem;background: #369593;color:#ffffff">保存</a>
                         </span>
                        <span class="btn-upload c">
...
<script type="text/javascript">
$(function(){
	$('.saveTabTwoThree').click(function() {
		var data = $('form#form-collection-add').serialize();
		$.ajax({
			url : "<%=request.getContextPath() %>/back/oCCollection/addOrUpdate.do",
			type : "post",
