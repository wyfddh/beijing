	...
	<body>
        ...
        <div class="top">	        	           
	               <div class="container mycontainer">
	                   <div class="row myrow">
	                       <div class="col-md-2">
	                          <img src="${topic.iconUrl}" id="iconUrl" onerror="Javascript:this.src='<%=request.getContextPath() %>/back/images/null_pic-12491114727.jpg' " width="200px" height="200px">
	                              <input type="hidden" class="layui-input" name="iconUrl" id="iconUrlPlus" value="${topic.iconUrl}">
	                       </div>
	                       <div class="col-md-10">
	                            <div class="row myrow">
                                   ...
                                   <div class="col-md-6 labelcss">
                                        <div style="height:100%;position:absolute;right:0px;">
                                            <c:if test="${sessionScope.btn.edit == 1 and topic.isShow == '1' and topic.status != '2'}">
	                               ...
	                               <div class="col-md-8">
	                                   ...
	                                   <div class="row myrow">
			                           		<div class="col-md-4">
			                           		   <i class="Hui-iconfont">&#xe64b;</i>
		                                       <label>专题分类</label>
		                                       <p id="typeName" style="color:gray;">${topic.typeName}</p>
			                           		</div>
			                           </div>
	                                   <%-- <br>
		                               <div class="row myrow">
		                                   ...
		                                   <div class="col-md-6 labelcss">
		                                        ...
		                                        <p style="color:gray;">		                                        
			                                        ...
			                                        <c:if test="${topic.startTime != null}">-</c:if>
                ...
                <div class="row" >
                    <div class="col-md-3">
                        <div>
	                       ...
	                       <c:if test="${sessionScope.btn.config == 1 and topic.isShow == '1' and topic.status != '2'}">
       ...
       <script type="text/html" id="barDemo">
		...
		//编辑按钮
		 $("#edit").click(function(){
			 ...
			 var url = '<%=request.getContextPath() %>/topic/goEditTopicPage.do?';
			 ...
			 layer.open({
                 ...
                 ,id: 'layerDemo' //防止重复弹出
                 ,title: name
                 ,content: ['<%=request.getContextPath() %>/CollectionTopic/goEditTopicPage.do?topicId='+topicId,'yes']
                 ,area: ['780px', '650px']
			     ,offset: ['15%', '30%']
                 ,shade: 0 //不显示遮罩
                 ,yes: function(){
