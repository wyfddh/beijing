...
<section  class="contentWrap">
    <form  class="form form-horizontal" action="<%=request.getContextPath() %>/activity/addOrUpdate.do" id="subForm" method="post" enctype="multipart/form-data">
        <div class="fixedHead">
        ...
        <div class="addMainPic">
            <div id="imgWrap" class="upPic">
                ...
                <input type="hidden" name="pictureId" id="picId">
            </div>
        </div>

        <div class="addTitle">
            <input type="text" name="activityName" placeholder="请输入活动名称" id="name">
        </div>
        ...
        <div class="activityInfo">
            ...
            <div class="time">
                ...
                <input type="text" name="activityDate" onfocus="WdatePicker()" id="datemin1" class="timeInput Wdate">
                <input type="text" name="specificDate" onfocus="WdatePicker({dateFmt:'HH:mm:ss'})" id="datemin" class="timeInput Wdate">
            </div>

            <div class="time">
                <label for="datemin"><span>*</span> 地点 :</label>
                <input type="text" name="activityPlace" placeholder="活动地点" id="address">
            </div>
        </div>

        <div class="contentEdit">
            <script id="editor" type="text/plain" style="width:100%;" name="content"></script>
        </div>
