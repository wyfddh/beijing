...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
   ...
   <script type="text/javascript" src="<%=request.getContextPath()%>/back/lib/jquery/1.9.1/jquery.min.js"></script> 
    ...
    <!--/meta 作为公共模版分离出去-->
    <link rel="stylesheet" href="<%=request.getContextPath() %>/upload/jquery-publicity20151104//layer/skin/default/layer.css" type="text/css">
...
<section class="contentWrap">
    <form class="form form-horizontal" id="subForm" action="<%=request.getContextPath()%>/spreadtrum/addAndUpdate.do" method="post" enctype="multipart/form-data">
        <div class="fixedHead">
            <div class="title">发布展览</div>
        ...
        <div class="addMainPic">
            <div id="imgWrap" class="upPic">
                ...
                <input type="hidden" name="picture" id="picId">
            </div>
        </div>

        <div class="addTitle">
            <input type="text" name="headline" placeholder="请输入展览名称" id="title">
        </div>

        <div class="displayType">
            <div class="radio-box">
                <input type="radio" id="radioOne" name="exhibitioType" value="0">
                <label for="radioOne">临时展览</label>
            </div>
            <div class="radio-box">
                <input type="radio" id="radioTwo" name="exhibitioType" value="1" checked>
                <label for="radioTwo">常设展览</label>
            </div>
            <span class="text-c hide" style="text-align: left;" id="dis"> 展期：
                <input type="text" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}'})" id="datemin" name="staTime" class="input-text Wdate" style="width:120px;">
                到
                <input type="text" onfocus="WdatePicker({minDate:'#F{$dp.$D(\'datemin\')}'})" id="datemax" name="overTime"  class="input-text Wdate" style="width:120px;">
            </span>
        </div>
        ...
        <div class="audioPlayer">
            <audio controls src="" preload="true"></audio>
        </div>
        ...
        <%--<p id="issue">--%>
            <%--<span id="issueTime">发布人：<input style="outline: none;border: none;font-size:15px;" value="${userName} "/></span>--%>
            <%--<span id="issuePerson" name="founder">发布单位：<span><input style="outline: none;border: none;font-size:15px;" value="${userOrga} "/></span></span>--%>
        <%--</p>--%>

        <%--<p class="mt-20">PC端虚拟展厅地址(URL)：<input type="text" id="pcurl" class="input-text" style="width: 50%" name="viPCUrl"></p>--%>
        <%--<p>移动端虚拟展厅地址(URL)：<input type="text" id="mobilurl" class="input-text" style="width: 50%" name="viMoveUrl"></p>--%>
    </form>
