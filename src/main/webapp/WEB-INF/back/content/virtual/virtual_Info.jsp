...
<body>
    <section class="contentWrap">
        <form class="form form-horizontal" action="<%=request.getContextPath()%>/virtual/addAndUpdate.do" method="post" id="subForm">
        	<input type="hidden" value="${virtual.id}" name="id">
            <div class="fixedHead">
            ...
            <div class="addMainPic">
                <div id="imgWrap" class="upPic">
                    ...
                    <img src="${virtual.viAddress}" class="newImg" id="image_id" alt="图片加载失败">
                    <input type="hidden" name="viMasterMap" id="picId" value="${virtual.viMasterMap}"/>
                </div>
            </div>

            <div class="addTitle">
                <input type="text" name="viName" placeholder="请输入虚拟展厅名称" id="title" value="${virtual.viName}">
            </div>

            <div class="virtualType">
                <select name="viClassify" size="1" value="${virtual.viClassify}">
            ...
            <div class="virtualUrl">
                ...
                <p class="urlWrap"><span class="urlTitle">PC端(URL)</span><input type="text" id="pcurl" name="viPCUrl" value="${virtual.viPCUrl}"></p>
                <p class="urlWrap"><span class="urlTitle">移动端(URL)</span><input type="text" id="mobilurl" name="viMoveUrl" value="${virtual.viMoveUrl}"></p>
            </div>

            <div class="simpleIntroduce">
                <label class="subTitle topVertical"><span>*</span> 简介</label>
                <textarea name="viIntro" cols="20" rows="30"  placeholder="说点什么...最少输入10个字符" onKeyUp="textarealength(this,100)">${virtual.viIntro}</textarea>
                <p class="textarea-numberbar"><em class="textarea-length">0</em>/100</p>
            </div>
            <%--<p id="issue">--%>
            <%--<span  name="viCreater">创建时间：<span>${virtual.staTime}</span></span>--%>
            <%--<span id="issuePerson" >创建人：<span>${virtual.userName}</span></span>--%>
            <%--<span id="issuePerson" >最后编辑人：<span>${virtual.lastPerson}</span></span>--%>
            <%--<span id="issuePerson" >最后编辑时间：<span>${virtual.viLastTime}--%>
            <%--</span></span>--%>
            <%--</p>--%>
        </form>
        <!--图片遮罩层开始-->
    ...
    <script type="text/javascript" src="<%=request.getContextPath() %>/back/lib/ueditor/1.4.3/ueditor.all.js"> </script>
